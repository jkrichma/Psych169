...
public class IOIO_thread_rover_tank extends IOIO_thread
{
    ...
    private AnalogInput irLeft, irCenter, irRight, irBack;
    float speed_left, speed_right;
    boolean direction_left, direction_right;
    float irLeftReading, irCenterReading, irRightReading, irBackReading;
    ...
    public void setup() throws ConnectionLostException
    {
        try
        {
            ...
            irBack = ioio_.openAnalogInput(45);
    ...
    public void loop() throws ConnectionLostException
    {
        ...
        try
        {
            ...
            irLeftReading = irLeft.read();
            irCenterReading = irCenter.read();
            irRightReading = irRight.read();
            irBackReading = irBack.read();
            // Log.d("robo", "in loop");
    ...
    public float getIrBackReading() {return irBackReading;}
